...
import com.example.shoppingapplication.ResetPasswordActivity;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    private Button updateButton, securityQuestionButton;
    ...
    protected void onCreate(Bundle savedInstanceState) { super.onCreate(savedInstanceState);
        ...
        fullNameEditText = (TextInputEditText) findViewById(R.id.settings_full_name_input);
        userPhoneEditText = (TextInputEditText) findViewById(R.id.settings_phone_number_input);
        addressEditText = (TextInputEditText)findViewById(R.id.settings_address_input);
        profileChangeTextBtn = findViewById(R.id.profile_image_change_btn);
        closeTextBtn = findViewById(R.id.close_settings_btn);
        updateButton = findViewById(R.id.update_account_settings_btn);
