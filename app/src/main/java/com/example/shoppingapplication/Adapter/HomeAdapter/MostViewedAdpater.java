...
public class MostViewedAdpater extends RecyclerView.Adapter<MostViewedAdpater.MostViewedViewHolder> {
    ...
    ArrayList<MostViewedHelperClass> mostViewedViewHolder;

    public MostViewedAdpater(ArrayList<MostViewedHelperClass> mostViewedLocations) {
        this.mostViewedViewHolder = mostViewedLocations;
    }
    ...
    public void onBindViewHolder(@NonNull MostViewedViewHolder holder, int position) {
        MostViewedHelperClass helperClass = mostViewedViewHolder.get(position);
    ...
    public int getItemCount() {
        return mostViewedViewHolder.size();
    }
